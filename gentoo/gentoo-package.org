...
mount -t proc proc  /mnt/zram0/proc
mount --rbind /sys  /mnt/zram0/sys
mount --make-rslave /mnt/zram0/sys
mount --rbind /dev  /mnt/zram0/dev
mount --make-rslave /mnt/zram0/dev


chroot /mnt/zram0/ /bin/bash
source /etc/profile
export PS1="(chroot) $PS1"


mount -o subvol=fs2/snapshot20160210,defaults,noatime,noacl,compress=lzo,inode_cache,space_cache,autodefrag /dev/sdd /mnt/fs2


cp -L /etc/resolv.conf /mnt/fs2/etc/

mount -t proc proc  /mnt/fs2/proc
mount --rbind /sys  /mnt/fs2/sys
mount --make-rslave /mnt/fs2/sys
mount --rbind /dev  /mnt/fs2/dev
mount --make-rslave /mnt/fs2/dev


chroot /mnt/fs2/ /bin/bash
source /etc/profile
export PS1="(chroot) $PS1"
...
umount -l /mnt/fs3/dev{/shm,/pts,}
umount -l /mnt/fs3{/boot,/sys,/proc,}
...
#
umount -l /var/tmp/gentoo/dev{/shm,/pts,}
umount -l /var/tmp/gentoo{/boot,/sys,/proc,}

umount -l /mnt/gentoo/dev{/shm,/pts,}
umount /mnt/gentoo{/sys,/proc,}


umount -l /mnt/fs2/dev{/shm,/pts,}
umount -l /mnt/fs2{/sys,/proc,}
